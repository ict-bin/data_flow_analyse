...
LEASE_TTL_SECONDS = int(os.environ.get("DFA_LEASE_TTL_SECONDS", "300"))
HEARTBEAT_INTERVAL_SECONDS = int(os.environ.get("DFA_HEARTBEAT_INTERVAL_SECONDS", "60"))
LEASE_REQUEUE_DELAY_SECONDS = int(os.environ.get("DFA_LEASE_REQUEUE_DELAY_SECONDS", "60"))
DISPATCH_POLL_INTERVAL_SECONDS = float(os.environ.get("DFA_DISPATCH_POLL_INTERVAL_SECONDS", "2"))
MAX_LOCAL_RUNNING_TASKS = int(os.environ.get("DFA_MAX_LOCAL_RUNNING_TASKS", "1"))
